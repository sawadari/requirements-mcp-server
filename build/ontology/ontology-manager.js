...
export class OntologyManager {
     ...
     * 許可される親段階を取得
     */
    getAllowedParentStages(stageId) {
     ...
     * 派生が妥当か検証
     */
    validateDerivation(parentStageId, childStageId) {
