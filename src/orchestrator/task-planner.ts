...
export class TaskPlanner {
   ...
   * 要求ツリー作成プラン
   */
  private createAddTreePlan(intent: Intent): ExecutionPlan {
    return {
      steps: [
        {
          id: 'step1',
   ...
   * 単一要求追加プラン
   */
  private createAddRequirementPlan(intent: Intent): ExecutionPlan {
    return {
      steps: [
        {
          id: 'step1',
   ...
   * 妥当性チェックプラン
   */
  private createValidatePlan(intent: Intent): ExecutionPlan {
   ...
   * 検索プラン
   */
  private createSearchPlan(intent: Intent): ExecutionPlan {
    return {
      steps: [
        {
          id: 'step1',
   ...
   * 自動修正プラン
   */
  private createFixPlan(intent: Intent): ExecutionPlan {
    return {
      steps: [
        {
          id: 'step1',
   ...
   * デフォルトプラン
   */
  private createDefaultPlan(intent: Intent): ExecutionPlan {
    return {
      steps: [
        {
          id: 'step1',
