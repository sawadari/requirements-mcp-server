...
export class MCPChatAssistant {
  ...
  async initialize(): Promise<void> {
    ...
    try {
      ...
      // 利用可能なツールを取得
      const toolsResponse = await this.mcpClient.listTools() as any;
 ...
 * シングルトンインスタンスを作成
 */
let instance: MCPChatAssistant | null = null;

export async function createMCPChatAssistant(): Promise<MCPChatAssistant> {
  if (!instance) {
...
export async function getMCPChatAssistant(): Promise<MCPChatAssistant | null> {
  return instance;
}
